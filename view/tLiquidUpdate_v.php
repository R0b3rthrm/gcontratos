<script src="js/tLiquid/update.js"></script>
<br/>
<rigth>
    &nbsp;&nbsp; 
    <a href="tLiquid" class="button special icon fa-download">NUEVO REGISTRO</a>
    <a href="tLiquidList" class="button special icon fa-search">LISTADO</a></rigth>
<CENTER>   


    <form action="controller/tLiquid_c.php" method="post"  id="frmTLiquid" name = "frmTLiquid">

        <h1>ACTUALIZAR TIPO DE LIQUIDACION </h1><h2 id='lblId'></h2>
