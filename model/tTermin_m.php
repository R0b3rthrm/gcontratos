...
class tTermin extends conexion {
    ...
    public function save() {
        ...
        $sql = "INSERT INTO t_termin  VALUES(0,"
                . "'" . $this->getSbCod() . "',"
                . "'" . $this->getSbNombre() . "',"
                . $this->getNuEstado() . ")";
    ...
    public function getListId() {
        ...
        $arrInfo = array();
        conexion::conectar();
        $sql = "select * from t_termin  where id = " . $this->getNuId();
        $result = conexion::query($sql);
    ...
    public function getList($select) {
        ...
        $arrInfo = array();
        conexion::conectar();
        $sql = "select " . $select . " from t_termin t inner join estado e on t.estado_id = e.id";
        $result = conexion::query($sql);
