...
class tPoliza extends conexion {
    ...
    public function save() {
        ...
        $sql = "INSERT INTO t_poliza  VALUES(0,"
                . "'" . $this->getSbCod() . "',"
                . "'" . $this->getSbNombre() . "',"
                . $this->getNuEstado() . ")";
    ...
    public function getListId() {
        ...
        $arrInfo = array();
        conexion::conectar();
        $sql = "select * from t_poliza  where id = " . $this->getNuId();
        $result = conexion::query($sql);
    ...
    public function getList($select, $where = '', $order = '', $tipoSelect = '') {
        ...
        $arrInfo = array();
        conexion::conectar();
        $sql = "select " . $select . " from t_poliza t inner join estado e on t.estado_id = e.id";
