...
class mSelecc extends conexion {
    ...
    public function save() {
        ...
        $sql = "INSERT INTO m_selecc  VALUES(0,"
                . "'" . $this->getSbCod() . "',"
                . "'" . $this->getSbNombre() . "',"
                . $this->getNuEstado() . ")";
    ...
    public function getListId() {
        ...
        $arrInfo = array();
        conexion::conectar();
        $sql = "select * from m_selecc  where id = " . $this->getNuId();
        $result = conexion::query($sql);
    ...
    public function getList($select) {
        ...
        $arrInfo = array();
        conexion::conectar();
        $sql = "select " . $select . " from m_selecc m inner join estado e on m.estado_id = e.id";
        $result = conexion::query($sql);
