...
class tIntervt extends conexion {
    ...
    public function save() {
        ...
        $sql = "INSERT INTO t_intervt  VALUES(0,"
                . "'" . $this->getSbCod() . "',"
                . "'" . $this->getSbNombre() . "',"
                . $this->getNuEstado() . ")";
    ...
    public function getListId() {
        ...
        $arrInfo = array();
        conexion::conectar();
        $sql = "select * from t_intervt  where id = " . $this->getNuId();
        $result = conexion::query($sql);
    ...
    public function getList($select, $where = '', $order = '', $tipoSelect = '') {
        ...
        $arrInfo = array();
        conexion::conectar();
        $sql = "select " . $select . " from t_intervt t inner join estado e on t.estado_id = e.id";
